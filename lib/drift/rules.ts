...
export const DRIFT_RULES: DriftRule[] = [
  {
    ...
    patterns: [
      ...
      // Indirect decision advice / mechanism takeover
      /\bforcing a (clean )?answer\b/i,
      /\bforce(?:s|ing)? (?:a )?(?:clean |final )?answer\b/i,
      /\bhands power to\b/i,
      /\bwhichever side is louder\b/i,
      /\btoo early usually\b/i,
      /你应该/,
      /你可以先/,
      /先把/,
      /先处理/,
  ...
  },
  {
    ...
    patterns: [
      ...
      // Qualified presence promises still count as companion posture
      /\bi can stay\b/i,
      /\bi will stay\b/i,
      /\bquiet and real with you\b/i,
      /\breal with you for a (moment|while)\b/i,
