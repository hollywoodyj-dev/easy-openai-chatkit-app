...
- **Milestone H** (micro awareness — **execution started**): formal addendum **`docs/HC_OS_V1_Milestone_H_Addendum_Minimal_Everyday_Integration_Micro_Awareness_Layer.md`**.  
