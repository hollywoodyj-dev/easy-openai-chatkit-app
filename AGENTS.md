...
- Milestone J addendum: `docs/HC_OS_V1_Milestone_J_Addendum_Micro_Shift_Embodied_Effect_Layer.md` (execution QA artifacts TBD under Tree/Lumen once Stream 4 runs)
