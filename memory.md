...
- **2026-07-17 Lumen P1 legibility Preview QA:** **HOLD for hosted Preview signoff.** Local Preview-flag behaviour passes (IL-P02–P04, P06, P09 local; P01/P08 prod guard; 6/6 unit). Blocker: hosted Preview not reachable (Vercel login; no bypass secret); deployment target ambiguous (2026-07-17 deploy = `production`; visible Preview = 2026-07-08). Artifact `docs/qa/P1_INTERACTION_LEGIBILITY_PREVIEW_SLICE_LUMEN_QA_2026-07-17.md`; screenshots local only in `qa-artifacts/`. **Open:** commit/push P1 slice (was uncommitted at QA time), Preview env flag, bypass for Lumen. Watchpoint: typing hides P1 block but P0 permission line may reappear (existing P0 behaviour).
