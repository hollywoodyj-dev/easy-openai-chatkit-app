...
- **2026-07-11 Tree (P1.1 planning approved):** First Question Invitation only — **planning + default-off implementation authorized**; **not** Production UI. Lumen fixtures F01–F11 at `docs/qa/P1_1_FIRST_QUESTION_INVITATION_LUMEN_FIXTURES_2026-07-11.md`. Nova plan at `docs/Wisewave_Product_Milestone_P1_1_First_Question_Invitation_Nova_Implementation_Plan_v1.md`. Governing line: *open the door, not lead through*. Entry Examples = separate candidate, not combined. Aurora invitation copy approved 2026-07-10; ZH first-question text still TBD. Release gate: Aurora → Nova flag-off build → Lumen F01–F11 Preview → Tree Production. **No code written yet** unless steward requests Slice 1.
